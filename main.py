...
for imagePath in paths.list_images(args["images"]):
    ...
    # generating the kernel,motion blur
...
for imagePath in paths.list_images(args["images"]):
    ...
    for i in range(0, detections.shape[2]):
        ...
        if confidence > args["confidence"]:
            ...
            if (iou >= correctValue):
                true_pos += 1
            elif (iou < correctValue):
                false_pos += 1

            calcPrecisionRecall(photo_name,true_pos,false_pos,false_neg,0)
...
#python main.py -i C:\Users\Lenovo\Desktop\bakalarka\Celeb -p C:\Users\Lenovo\PycharmProjects\faceDetection\opencv\samples\dnn\
#face_detector\deploy.prototxt -m C:\Users\Lenovo\PycharmProjects\faceDetection\res10_300x300_ssd_iter_140000.caffemodel
